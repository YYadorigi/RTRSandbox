...
RenderTexture2D::RenderTexture2D(
	...
	unsigned int minFilter,
	unsigned int magFilter
) : Texture(GL_TEXTURE_2D_MULTISAMPLE), multisampled(true), internalFormat(internalFormat)
{
...
RenderTexture2D::RenderTexture2D(
	...
	unsigned int minFilter,
	unsigned int magFilter
) : Texture(GL_TEXTURE_2D), multisampled(false), internalFormat(internalFormat)
{
